...
import { Port, type ShapePort } from "../../ports/Port";
...
export function ConditionalNodeComponent({
  shape,
  node,
}: NodeComponentProps<ConditionalNode>) {
