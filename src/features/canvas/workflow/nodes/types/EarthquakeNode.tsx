...
import type { ShapePort } from "../../ports/Port";
...
export function EarthquakeNodeComponent({
  shape,
  node,
}: NodeComponentProps<EarthquakeNode>) {
    ...
    <div className="EarthquakeNode">
      <NodeRow>
        <div className="NodeValue">
          ...
          {isLoading ? "…" : earthquakeData?.magnitude.toFixed(1)}
        </div>
      </NodeRow>
      <NodeRow>
        <div className="NodeValue" style={{ fontSize: "12px" }}>
          <strong>Location:</strong>{" "}
          {isLoading ? "…" : earthquakeData?.location}
        </div>
      </NodeRow>
      <NodeRow>
        <div className="NodeValue" style={{ fontSize: "12px" }}>
