...
export class ConnectionShapeUtil extends ShapeUtil<ConnectionShape> {
  ...
  onHandleDrag(
    ...
    const hasExistingConnection =
      target?.existingConnections.some(
...
function ConnectionShape({ connection }: { connection: ConnectionShape }) {
  ...
  const isInactive = useValue("isInactive", () => {
...
export function getConnectionPageCenter(
  ...
  const startPage = getConnectionBindingPositionInPageSpace(
    editor,
    bindings.start,
  );
...
export function getConnectionTerminals(
  ...
  if (bindings.start) {
    const inPageSpace = getConnectionBindingPositionInPageSpace(
      editor,
      bindings.start,
    );
    if (inPageSpace) {
